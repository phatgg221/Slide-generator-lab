...
- **`generate_web_deck(collection, brief, …)`** — steps 3·5·6·(7)·8 over one
  collection (the library plans + writes from your brief).
...
# 3. tag it
git tag v0.2.6 && git push origin main --tags
```
